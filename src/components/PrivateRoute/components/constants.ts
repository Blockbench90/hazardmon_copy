...
export const HISTORICAL = "/dashboard/historical"
...
export const CUSTOM_HISTORICAL_GRAPHS = "/graphs/historical/graphs"
export const NOTIFICATIONS = "/notifications"
export const ANALYTICS = "/analytics"
export const VISUAL_DASHBOARD = "/visual"
export const EMAIL_NOTIFICATIONS = "/user/setting/notification"
export const EMAIL_ADD_NOTIFICATIONS = "/user/setting/add/notification"
