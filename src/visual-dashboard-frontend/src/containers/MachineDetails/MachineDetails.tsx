...
class MachineDetails extends React.Component<MachineDetailsProps> {
    public componentDidMount() {
        const { getMachineDetails, getMachineNotifications, toggleMachineSocket, getMachineMaintenance } = this.props;
        getMachineDetails();
    ...
    public render() {
        const { machineDetails, machineDetailsNotifications, machineDetailsMaintenance, match, currentUser } = this.props;
